                                    ...
                                    <div class="panel panel-info">
                                        ...
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" href="#{{$category->id}}{{-- str_replace(' ', '-', $category->name) --}}">{{ $category->name }}</a>
                                            </h4>
                                        </div>
                                            {{-- why i use str_replace(' ', '-', $category->name) becuase category->name can be two words so its problem to call another div so i reformat to be this  Category->name = x-y --}}
                                        <div id="{{$category->id}}{{-- str_replace(' ', '-', $category->name) --}}" class="panel-collapse collapse">
